...
namespace UnityStandardAssets.Cameras
{
    public class ProtectCameraFromWallClip : MonoBehaviour
    {
        ...
        public bool protecting { get; private set; }    // used for determeining if there is an object between the target and the camera
		...
		public LayerMask clippingLayers = -1; 	//The layers of colliding objetcs
